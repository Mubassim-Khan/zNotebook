...
export const About = () => {
  useEffect(() => {
    document.title = 'About - zNotebook'
  }, [])
      ...
      <TrackVisibility>
        {({ isVisible }) =>
          <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
            <h2 className='about--heading'>About zNotebook</h2>
            <p className='about-text-center'>
              zNotebook is your personalized note taking app, where you can store your notes over cloud & can access them anywhere, anytime.
            </p>
        ...
        {({ isVisible }) =>
          <div className={isVisible ? "animate__animated animate__fadeInUp" : ""}>
            ...
            <p className='about-text mb-4'>
              Ready to start jotting down your thoughts? Join the <strong> zNotebook</strong> now by creating the account or log in (if already have an account) or click <strong>+</strong> icon, where you can create a new note,
